...
//$Referer_check_domain = "https://onsefa.com/";
...
$subject = "御アートメイク（KARIS Beauty Clinic）のランディングページ";
...
$require = array('ご希望・ご相談','来院','お名前','フリガナ','ご住所','生年月日-年','生年月日-月','生年月日-日','Email','電話番号','予約・第１希望日','希望時間１','予約・第２希望日','希望時間２','予約・第３希望日','希望時間３');
...
$re_subject = "お問い合わせありがとうございます。（自動返信メール）";
...
お問い合わせありがとうございます。
担当者よりまた後日ご連絡させていただきます。

万が一、数日経っても連絡がない場合は、誠にお手数ですが下記までご連絡くださいませ。

またこのメールに心当たりのない方はお手数ですが
本メールを破棄してください。
...
────────────────────────
御アートメイク（KARIS Beauty Clinic）
〒151-0053 東京都渋谷区代々木2-7-3 第七荒井ビル 8階
診療時間　10:00～19:00
